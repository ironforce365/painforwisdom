...
do not write curator_summary.md. Output nothing else. End your response here.
You will be re-invoked with the reply as additional input.
...
_index.md, do not write curator_summary.md. Output nothing else. End your
response here. You will be re-invoked with the reply as additional input.
