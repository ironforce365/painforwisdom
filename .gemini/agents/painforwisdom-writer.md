...
### Step 3 — write_file the post following ALL rules below:
...
- **First person, unfiltered**: write_file like thinking out loud. Raw, honest, direct.
...
write_file the full blog post to:
